...
class Loan {
    ...
    private fun calcDeductionFixed(term: Double, interest: Double): Double {
        return term - interest
    }

    private fun calcDeductionLinear(amount: Double, length: Int): Double {
        return amount / length
    }

    private fun calcInterest(amount: Double, interest: Double): Double {
        return amount * (interest / 100)
    }

    private fun calcRemaining(amount: Double, deduction: Double): Double {
        return amount - deduction
    }

    private fun calcTermLinear(deduction: Double, interest: Double): Double {
        return deduction + interest
    }
